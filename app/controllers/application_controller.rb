...
class ApplicationController < ActionController::API
  ...
  def authenticate_admin_or_inventoryer_or_arriver
    return if user_signed_in? && (current_user.authority.admin? || current_user.authority.inventoryer? || current_user.authority.arriver?)
